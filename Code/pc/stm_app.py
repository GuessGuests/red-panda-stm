...
class App(tk.Tk):
    ...
    def setup_control_widgets(self):
        ...
        add_separator()
        add_control_widget(_DACControlWithScaling, label="Bias", stm=self.stm, set_dac_func=self.stm.set_bias, dac_to_volts_func=stm_control.STM.dac_to_bias_volts, set_scaling_func=self.stm.set_bias_scaling_factor, get_scaling_func=lambda: stm_control.STM.bias_scaling_factor)
        add_control_widget(_DACControlWithScaling, label="DACZ", stm=self.stm, set_dac_func=self.stm.set_dacz, dac_to_volts_func=stm_control.STM.dac_to_dacz_volts, set_scaling_func=self.stm.set_z_scaling_factor, get_scaling_func=lambda: stm_control.STM.z_scaling_factor)
        add_control_widget(_DACControlWithScaling, label="DACX", stm=self.stm, set_dac_func=self.stm.set_dacx, dac_to_volts_func=stm_control.STM.dac_to_dacx_volts, set_scaling_func=self.stm.set_x_scaling_factor, get_scaling_func=lambda: stm_control.STM.x_scaling_factor)
        add_control_widget(_DACControlWithScaling, label="DACY", stm=self.stm, set_dac_func=self.stm.set_dacy, dac_to_volts_func=stm_control.STM.dac_to_dacy_volts, set_scaling_func=self.stm.set_y_scaling_factor, get_scaling_func=lambda: stm_control.STM.y_scaling_factor)
        add_separator()
    ...
    def _plot_iv_curve(self, *args):
        try:
            ...
            bias_volts = [self.stm.dac_to_bias_volts(d) for d in sorted_bias_dac]
